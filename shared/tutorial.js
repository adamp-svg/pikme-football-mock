  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'bomb', controls: ['move', 'aim', 'bomb'], spotlight: 'bomb', gesture: 'pull',
        marker: 'foe', markerKey: 'foe', cap: 'פצצה!', nudge: 'גרור את הפצצה אליו', nudgeAfter: 10, done: 'bombHitFoe' },
      ...
      { id: 'wall', controls: ['move', 'aim', 'bomb', 'wall'], spotlight: 'wall', gesture: 'pull',
        marker: 'foe', markerKey: 'foe', cap: 'בנה קיר!', nudge: 'גרור את הקיר וסתתר', nudgeAfter: 10, done: 'wallBuilt' },
...
export function advance(l, n, ctx = {}) {
  ...
  return isStepDone(l, n, ctx) ? n + 1 : n;
}
