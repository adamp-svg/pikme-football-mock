...
- `step-grass-1.mp3` ← `footstep_grass_000.ogg`
- `step-grass-2.mp3` ← `footstep_grass_002.ogg`
- `kick.mp3` ← `impactSoft_heavy_001.ogg`
- `hit.mp3` ← `impactPunch_medium_002.ogg`
- `pickup.mp3` ← `powerUp7.ogg`
- `shot.mp3` ← `laser5.ogg`
